...
function AboutPoco() {
    return (
        <div className="container px-0">
            ...
            <p>This patented design is still in the works. But you can help us by supporting POCo. now, in the early stages! All proceeds go towards the production of this jacket and other gear we’re innovating. </p>
        </div>
    );
};
